...
Problema:
\begin{itemize}
 \item Localizzazzione di robot autonomi in complessi ambienti indoor
...
\begin{itemize}
 ...
 \item Localizzazzione basata su oggetti come landmark 
\end{itemize}
...
\centering{\includegraphics[height=0.8\paperheight]{immagini/sistema}}
